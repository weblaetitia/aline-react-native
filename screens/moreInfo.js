	...
	if (!fontsLoaded) {
		...
		return (
			<ScrollView>
				...
				<TouchableOpacity
					onPress={() =>
						Linking.openURL('https://aline-consigne.herokuapp.com')
					}>
					<ListItem
						rightIcon={
          ...
          >
				...
				/>
				<ListItem
					rightIcon={<FontAwesome name='share-alt' size={20} color={mint} />}
					titleStyle={{ color: '#033C47' }}
				...
				<ListItem
					...
					bottomDivider
				/>
				<ListItem titleStyle={{ color: blueDark }} title='CGU' bottomDivider />
			</ScrollView>
		);
	}
}
