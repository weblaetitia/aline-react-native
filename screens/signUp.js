...
function signUpScreen(props) {
  ...
  switch (alert) {
    ...
    case "requireAll":
      alertMessage = (
        <Text style={styles.alert}>Tous les champs sont obligatoires</Text>
      );
      break;
    case "passwordsNotMatch":
      alertMessage = (
        <Text style={styles.alert}>Les mots de passe ne correspondent pas</Text>
      );
      break;
    default:
      alertMessage = <Text />;
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <View style={styles.container}>
          ...
          <View>
            <AlineInputCenter
              label="Votre prénom"
              onChange={(e) => setFirstNameInput(e)}
              placeholder="ex: John"
              style={{ flex: 1 }}
            />
            <AlineInputCenter
              label="Votre nom"
              onChange={(e) => setLastNameInput(e)}
              placeholder="ex: Doe"
              style={{ flex: 1 }}
            />
            <AlineInputEmail
